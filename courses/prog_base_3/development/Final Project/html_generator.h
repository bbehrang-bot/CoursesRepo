...
public:
	...
	std::string jquery = readFile("jquery.js");
	std::string slider = readFile("jquery.slides.min.js");
	std::string sliderFade = readFile("fadeSlideShow-minified.js");
	std::string validation = readFile("jquery.validate.js");
	...
	std::wstring html_companyInfo(const std::vector<std::vector<std::pair<std::string, std::string>>>& table_data, const std::string table_name);
	std::wstring html_MessagesAdmin(const std::vector<std::vector<std::pair<std::string, std::string>>>& table_data, const std::string table_name);
	...
	std::wstring html_homePage(std::wstring bodyPartial,Company company, const std::vector<std::vector<std::pair<std::string, std::string>>>& table_data);
	std::wstring html_productPage(Product product);
	std::wstring html_productDetailPage(Product product);
	std::wstring html_homePagePartial(std::vector<Product> products);
